...
object ErrorMessage {
    ...
    const val COUNT_INGREDIENTS = "Число инредиентов не может быть меньше 1 и больше 32"
    const val COUNT_STEPS = "Число шагов не может быть меньше 1 и больше 32"
    ...
    const val COUNT_NUTRIENTS = "Количество нутриентов не может быть больше 5000"
